...
SRC_URI="amd64? ( https://down.oray.com/sunlogin/linux/SunloginClient_${PV}_amd64.deb )
	arm64? ( https://down.oray.com/sunlogin/linux/SunloginClient_${PV}_kylin_arm.deb )"
